...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      <DeferredSection className="section-spacing bg-white" testId="about-section" placeholderClassName="min-h-[18rem]">
        <div className="container-main">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-6">
            {[
              ...
              <Card key={item.title} className="rounded-[20px] border-border shadow-sm hover:shadow-md transition-shadow duration-200 h-full">
      ...
      <DeferredSection className="section-spacing" testId="events-preview-section" placeholderClassName="min-h-[28rem]">
        <div className="container-main">
      ...
      <DeferredSection className="section-spacing bg-white" testId="training-preview-section" placeholderClassName="min-h-[26rem]">
        <div className="container-main">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div>
              ...
              <ul className="space-y-3 mb-6">
                {["Beginner intro sessions every month", "Safety-first approach to training", "One-on-one guidance from experienced trainers", "All equipment provided"].map((item) => (
                  <li key={item} className="flex items-start gap-2 text-sm"><CheckCircle2 className="w-4 h-4 text-[#1F7A4A] mt-0.5 flex-shrink-0" /><span>{item}</span></li>
                ))}
              </ul>
              <Link to="/training">
      ...
      <DeferredSection className="section-spacing" testId="community-section" placeholderClassName="min-h-[24rem]">
        <div className="container-main">
          <div className="text-center mb-10">
      ...
      <DeferredSection className="section-spacing bg-white" testId="newsletter-section" placeholderClassName="min-h-[20rem]">
        <div className="container-main">
