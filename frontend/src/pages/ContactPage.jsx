            ...
            <Card className="rounded-[20px] border-border shadow-md" data-testid="contact-form">
              <CardHeader>
                <CardTitle className="font-display text-lg flex items-center gap-2">
                  <MessageSquare className="w-5 h-5 text-[#0B74B5]" /> Send Us a Message
                </CardTitle>
              </CardHeader>
              <CardContent>
                {submitted ? (
                  <div className="text-center py-10">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        setSubmitted(false);
                        setForm({ name: "", email: "", message: "", volunteer_interest: false });
                      }}
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex items-start gap-3 p-3 bg-[#EAF7EF] rounded-xl border border-[#CFEBDD]">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => setForm({ ...form, volunteer_interest: checked === true })}
                        className="mt-0.5"
          ...
          <div className="space-y-5">
            ...
            <Card className="rounded-[20px] border-border shadow-sm">
              <CardContent className="p-5">
                ...
                <a href="mailto:hello@everydogleague.com" className="text-sm font-medium text-[#0B74B5] hover:underline">
